function notanchu(text) {
    $('.loading').hide();
    $(".allsuccess").addClass('on');
    $(".allsuccess .tanShow").text(text);
    setTimeout(function () {
        $(".allsuccess").removeClass('on');
    }, 3000);
}

function yestanchu(text) {
    $('.loading').hide();
    $(".allsuccess").addClass('on');
    $(".allsuccess .tanShow").text(text);
    setTimeout(function () {
...
function tiaozhuantanchu(text,url) {
    $(".allsuccess").addClass('on');
    $(".allsuccess .tanShow").text(text);
    setTimeout(function(){
...
$(window).on("load", function () {
    ...
    if($(window).width() < 1280) {
        ...
        $('#pagepiling').pagepiling({
            ...
            anchors: ['Home', 'About', 'Tokenomics', 'GiftFor$PEPE', 'Roadmap', 'Contact'],
            scrollingSpeed: 500,
            easing: 'linear',
            loopBottom: false,
            loopTop: false,
            ...
            navigation: {
                'bulletsColor': '#535353',
                'position': 'right',
                'tooltips': ['Home', 'About', 'Tokenomics', 'Gift For $PEPE', 'Roadmap', 'Contact'],
            },
            //events
